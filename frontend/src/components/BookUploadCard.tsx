    ...
    >
      {upload.isPending ? (
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-[var(--text-secondary)]">Uploading and extracting table of contents...</p>
        </div>
      ) : (
        <>
          <svg
            className="mx-auto h-12 w-12 text-[var(--primary)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <label className="mt-4 cursor-pointer rounded-lg bg-[var(--primary)] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[var(--primary-hover)]">
            Select PDF
            <input
              type="file"
